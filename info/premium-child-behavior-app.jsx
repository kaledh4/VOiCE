      ...
      <div style={{
        ...
        {!showCommunity ? (
          <>
                    ...
                    <div
                      ...
                      onMouseEnter={e => {
                        if (!isSelected) {
                          ...
                          e.currentTarget.style.boxShadow = `0 12px 24px ${char.color}30`;
                        }
                      }}
                      onMouseLeave={e => {
                        if (!isSelected) {
                    ...
                    <div
                      ...
                      onMouseEnter={e => {
                        if (!isSelected) {
                          ...
                          e.currentTarget.style.boxShadow = `0 8px 20px ${behavior.color}30`;
                        }
                      }}
                      onMouseLeave={e => {
                        if (!isSelected) {
            ...
            {/* Call Interface - Completely Redesigned */}
            ...
            {/* Active Call - Completely Redesigned */}
            {isCallActive && (
              <section style={{
                background: 'white',
                borderRadius: '32px',
                ...
                <div style={{
                  ...
                  <button
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.boxShadow = '0 8px 24px rgba(255,71,87,0.5)';
                    }}
                    onMouseLeave={e => {
                      e.currentTarget.style.transform = 'scale(1) rotate(0deg)';
                    }}
                ...
                <div style={{
                  ...
                  <button
                    onClick={() => {
                      ...
                      if (!isListening) {
                        setTimeout(() => {
                          simulateResponse('أنا أحب أن أرتب غرفتي كل يوم!');
                          setIsListening(false);
                        }, 3000);
                      }
                    }}
          ...
          /* Community Templates Section - New Design */
          <section style={{
            background: 'white',
            borderRadius: '32px',
            padding: '32px',
                ...
                return (
                  <div
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.boxShadow = `0 12px 32px ${char.color}30`;
                    }}
                    onMouseLeave={e => {
